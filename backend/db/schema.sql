...
--
-- Name: filevault_folders; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.filevault_folders (
    id integer NOT NULL,
    name text NOT NULL,
    user_id integer NOT NULL,
...
--
-- Name: filevault_folders_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.filevault_folders_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: filevault_folders_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.filevault_folders_id_seq OWNED BY public.filevault_folders.id;
...
--
-- Name: filevault_folders id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.filevault_folders ALTER COLUMN id SET DEFAULT nextval('public.filevault_folders_id_seq'::regclass);
...
--
-- Name: filevault_folders filevault_folders_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.filevault_folders
    ADD CONSTRAINT filevault_folders_pkey PRIMARY KEY (id);
...
CREATE INDEX idx_files_folder_id ON public.filevault_files_authed USING btree (folder_id);
...
CREATE INDEX idx_folders_parent ON public.filevault_folders USING btree (parent_folder_id);
...
CREATE INDEX idx_folders_user_id ON public.filevault_folders USING btree (user_id);
...
--
-- Name: filevault_files_authed filevault_files_authed_folder_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.filevault_files_authed
    ADD CONSTRAINT filevault_files_authed_folder_id_fkey FOREIGN KEY (folder_id) REFERENCES public.filevault_folders(id) ON DELETE SET NULL;
...
--
-- Name: filevault_folders filevault_folders_parent_folder_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.filevault_folders
    ADD CONSTRAINT filevault_folders_parent_folder_id_fkey FOREIGN KEY (parent_folder_id) REFERENCES public.filevault_folders(id) ON DELETE CASCADE;


--
-- Name: filevault_folders filevault_folders_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.filevault_folders
    ADD CONSTRAINT filevault_folders_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.filevault_users(id) ON DELETE CASCADE;
